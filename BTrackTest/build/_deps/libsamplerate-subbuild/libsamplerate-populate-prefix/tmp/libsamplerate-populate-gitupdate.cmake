...
if(error_code OR is_remote_ref OR NOT ("${tag_sha}" STREQUAL "${head_sha}"))
  ...
  if(error_code)
    message(FATAL_ERROR "Failed to fetch repository 'https://github.com/libsndfile/libsamplerate.git'")
  endif()
  ...
  if(is_remote_ref)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to rebase in: 'C:/Git/arduino-light-audio/BTrackTest/build/_deps/libsamplerate-src/'.\nYou will have to resolve the conflicts manually")
    endif()
    ...
    if(need_stash)
      ...
      if(error_code)
        ...
        if(error_code)
          ...
          message(FATAL_ERROR "\nFailed to unstash changes in: 'C:/Git/arduino-light-audio/BTrackTest/build/_deps/libsamplerate-src/'.\nYou will have to resolve the conflicts manually")
        endif()
      endif()
    endif()
  else()
